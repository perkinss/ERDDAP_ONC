...
"    Float64 actual_range 6.31152e\\+8, 1.41458142e\\+9;\n" + //2nd value changes   use \\+
"    String axis \"T\";\n" +
"    String ioos_category \"Time\";\n" +
"    String long_name \"Time\";\n" +
...
"    String acknowledgment \"These data were acquired from the US NOAA National Oceanographic " +
    "Data Center \\(NODC\\) on 2014-11-09 from http://www.nodc.noaa.gov/GTSPP/.\";\n" + //changes monthly
...
"    String defaultGraphQuery \"longitude,latitude,station_id&time%3E=2014-10-24&time%3C=2014-11-01&.draw=markers&.marker=1\\|5\";\n" +
...
"    String history \"2014-11-01 csun writeGTSPPnc40.f90 Version 1.7\n" +  //date changes
".tgz files from ftp.nodc.noaa.gov /pub/gtspp/best_nc/ \\(http://www.nodc.noaa.gov/GTSPP/\\)\n" +
"2014-11-09 Most recent ingest, clean, and reformat at ERD \\(bob.simons at noaa.gov\\).\n"; //date changes
...
"These data were acquired from the US NOAA National Oceanographic Data Center \\(NODC\\) on 2014-11-09 from http://www.nodc.noaa.gov/GTSPP/.\n" +
"\n" +
...
"\\*\\*\\* This ERDDAP dataset has data for the entire world for all available times \\(currently, " +
    "up to and including the October 2014 data\\) but is a subset of the " + //month changes
...
"http://www.nodc.noaa.gov/GTSPP/document/qcmans/qcflags.htm .\";\n" +
"    String time_coverage_end \"2014-10-29T11:17:00Z\";\n" + //changes
...
"2014-11-07 Bob Simons at NOAA/NMFS/SWFSC/ERD \\(bob.simons@noaa.gov\\) fully refreshed ERD's copy of this dataset by downloading all of the .cdf files from the PMEL TAO FTP site.  Since then, the dataset has been partially refreshed everyday by downloading and merging the latest version of the last 25 days worth of data\\.";
