...
public class EDDTableFromColumnarAsciiFiles extends EDDTableFromFiles { 
    ...
    public EDDTableFromColumnarAsciiFiles(String tClassName, String tDatasetID, String tAccessibleTo,
...
"-->\n" +
"\n" +
"<dataset type=\"EDDTableFromColumnarAsciiFiles\" datasetID=\"asciiNdbc_8443_4c8b_d0e1\" active=\"true\">\n" +
...
"} s;\n";
        ...
        String2.log("\n****************** EDDTableFromColumnarAsciiFiles.test make DATA FILES\n");       
