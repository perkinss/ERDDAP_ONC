...
//    String2.log(NcHelper.dumpString("c:/data/kerfoot/unit_236-20121005T2349.ncCF.nc3.nc", false));
//    String2.log(NcHelper.dumpString("/downloads/A2003001.L3m_DAY_POC_poc_4km", false));
...
//       EDDTableFromNcFiles.bobConsolidateGtsppTgz(2013, 3, 2014, 10, false);  //first/last year(1990..)/month(1..), testMode
...
//       EDDTableFromNcFiles.bobCreateGtsppNcCFFiles(2013, 3, 2014, 10); //e.g., first/last year(1990..)/month(1..)
